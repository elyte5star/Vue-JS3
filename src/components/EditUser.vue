                    ...
                    <form @submit.prevent="updateDetails">
                        <div class="text-center mb-3">
                            <div class="btn-group user-action">
                                ...
                                <button id="user_info" @click="changeActiveComponent('update-password')" class="btn btn-warning"><i class="fa fa-key"></i>
                                    UPDATE PASSWORD
                                </button>
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="editUsername"><i class="fa fa-user" aria-hidden="true"></i>
                                Username:</label>
                            <input :disabled="true" v-model="editUsername" type="text" id="editUsername" class="form-control" aria-describedby="usernameHelpBlock" />
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6"><label class="form-label" for="state"><i class="fa fa-globe" aria-hidden="true"></i> Country:</label>
                                <select v-model="bcountry" class="form-select" id="country" name="country">
                                    <option v-if="countries" v-for="country in countries" :key="country.text" :value=country.value>{{ country.text }}</option>
                                </select>
                            </div>
                            <div class="col-md-6"> <label class="form-label" for="zip"><i class="fa fa-map-pin" aria-hidden="true"></i> Zip:</label>
                                <input v-model="zip" class="form-control billing-inputs" type="text" id="zip" name="zip" placeholder="10001">
                            </div>
                        </div><br>
