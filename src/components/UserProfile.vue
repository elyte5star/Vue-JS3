  ...
  <div v-if="user_info">
    <div id="user" class="user">
      ...
      <div class="framed columnx" id="{{ user.userid }}">
        <div class="edit">
          <a href="javascript:void(0)" @click="changeActiveComponent('update_details')"><i class="fa fa-pencil-square-o"
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="ibox">
              <div class="ibox-title">
                <span class="pull-right">(<strong>{{ bookingsHistoryCount }}</strong>) orders</span>
                <h5>Order History</h5>
              </div>
              <div v-if="bookingsHistory">
                <div v-for="booking in bookingsHistory" v-bind:key="booking.oid" class="ibox-content">
          ...
          <div class="col-md-5">
            ...
            <div class="ibox-content">
              ...
              <div class="m-t-sm">
                <div class="btn-group">
                  <router-link id="cont_shopping" :to="{ name: 'Home' }"><i class="fa fa-arrow-left"></i> Continue
                    shopping</router-link>
                </div>
              </div>
            </div>
